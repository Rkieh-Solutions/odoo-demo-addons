...
class PickingRouteMapWizard(models.TransientModel):
    ...
    _description = 'Picking Route Map'
...
class PickingRouteMapLineWizard(models.TransientModel):
    ...
    _description = 'Picking Route Map Line'
    ...
    product_id = fields.Many2one('product.product', string='Product to Pick')
    qty = fields.Float(string='Quantity required')
    move_line_id = fields.Many2one('stock.move.line')
    is_picked = fields.Boolean(string='Picked?', readonly=True)
