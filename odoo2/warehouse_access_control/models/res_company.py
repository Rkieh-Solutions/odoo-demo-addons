...
class ResCompany(models.Model):
    ...
    quality_excellent_limit = fields.Float("Excellent Max Threshold (%)", default=5.0)
    quality_good_limit = fields.Float("Good Max Threshold (%)", default=15.0)
    quality_average_limit = fields.Float("Average Max Threshold (%)", default=30.0)
